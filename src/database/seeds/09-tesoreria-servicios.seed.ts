...
const SERVICIOS: ServicioCobrable[] = [
  // ── REGISTRO CIVIL ──────────────────────────────────────────────────
  {
    ...
    areaResponsable: 'Registro Civil',
    costo: 50,
    montoVariable: false,
  ...
  // ── AGUA Y SANEAMIENTO ───────────────────────────────────────────────
  {
    ...
    areaResponsable: 'Agua y Saneamiento',
    costo: 0,
    montoVariable: true,
    requiereContribuyente: true,
    orden: 11,
...
/** Mapa categoría → área responsable (para prellenar formularios) */
export const AREA_POR_CATEGORIA: Record<string, string> = {
  'Registro Civil': 'Registro Civil',
  'Predial': 'Tesorería',
  'Agua y Saneamiento': 'Agua y Saneamiento',
  'Licencias y Permisos': 'Gobernación',
  'Servicios Urbanos': 'Servicios Públicos',
  'Panteón': 'Panteón',
  'Constancias': 'Secretaría',
  'Tesorería General': 'Tesorería',
};
